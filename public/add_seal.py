...
with open("seals_data.json", encoding="utf-8") as f:
    data = json.load(f)

data["seals"]["Digital Vacation AT Seal"] = {
...
with open("seals_data.json", "w", encoding="utf-8") as f:
    json.dump(data, f, ensure_ascii=False, indent=2)

print(f"Listo — {len(data['seals'])} seals")